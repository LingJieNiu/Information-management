<%-- 
    ...
    Created on : Jun 23, 2015, 11:02:13 AM
    Author     : Ling
--%>
...
<form action="Assettype_Servlet" method="post" >
    ...
    <p id="Assetword">Put AssetID:<input type="text" name="AssetID"></p>
     <p id="AssetNameword">Put AssetName:<input type="text" name="AssetName"></p>
     <p id="Descriptionword">Put Description:<input type="text" name="Description"></p>
  <button type="submit" name="assettype" value="addassettype">Submit
   </button>
</form>    
