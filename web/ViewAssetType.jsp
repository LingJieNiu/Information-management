<%-- 
    Document   : ViewAssetType
    Created on : Jun 23, 2015, 11:24:54 AM
    Author     : Ling
--%>
...
<div class="row">
 ...
 <table width="90%" id="mytab"  border="1" class="t1">
  <thead>
    ...
    <%
          ArrayList<String>AssetID=(ArrayList<String>)request.getAttribute("AssetIDfromSQL");
           ArrayList<String>Name=(ArrayList<String>)request.getAttribute("AssetNamefromSQL");
           ArrayList<String>Description=(ArrayList<String>)request.getAttribute("AssetDescriptionfromSQL");
