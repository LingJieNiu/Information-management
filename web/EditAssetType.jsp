<%-- 
    ...
    Created on : Jun 23, 2015, 11:04:24 AM
    Author     : Ling
--%>
...
<div class="col-sm-3">
 ...
 <form action="MainSearch_Servlet" method="post">
...
<div class="row">
    ...
    <h3>What is the Asset you want to change?</h3>
    
    <p id="showinhere">here</p>
    ...
    <table width='90%' id='mytab'  border='1' class='t1'>
          <thead>
          <th width="20%">AssetID</th>
           <th width="30%">AssetName</th>
          ...
          <input type="button" name="assettype" value="edit it" onclick="EditsendMassageToServer()">
   
    
    </table>
    
   
    <p >Put AssetID:<input type="text" name="AssetID" id="AssetID"></p>
    
    <input type="button" name="assettype" value="editassettype" onclick="sendMassageToServer()">
...
if (window.XMLHttpRequest)
  ...
  function sendMassageToServer(){
      
      identity="1";
     xmlhttp.open("POST","test_servlet?AssetID="+document.getElementById("AssetID").value+"&identity="+identity,true);
  ...
  if (xmlhttp.readyState===4 && xmlhttp.status===200)
    ...
    var respXML=xmlhttp.responseXML;    
       ...
       //document.getElementById("showinhere").innerHTML= xmlhttp.responseText;
 
    name=respXML.getElementsByTagName("name")[0].childNodes[0].nodeValue;
    ID=respXML.getElementsByTagName("ID")[0].childNodes[0].nodeValue;
    description=respXML.getElementsByTagName("Description")[0].childNodes[0].nodeValue;
    ...
    function EditreceiveMessageFromServer(){     
  if (xmlhttp.readyState===4 && xmlhttp.status===200)
    {
    var respXML=xmlhttp.responseXML;    
	...
	{
	 var editID=document.getElementById("tdID").innerHTML;
	 var editName=document.getElementById("editName").value;
	 var editDescription=document.getElementById("editDescription").value;
	  
	 var queryString="test_servlet?editID=" + editID + "&editName=" + editName + "&editDescription=" + editDescription;
	 return queryString;
	}
        
    function EditsendMassageToServer(){
      identity="2";
      var queryString=createQueryString()+"&identity="+identity;
     xmlhttp.open("POST",queryString,true);
    
    xmlhttp.onreadystatechange=EditreceiveMessageFromServer;  
